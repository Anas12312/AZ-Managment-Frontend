  ...
  return (
    <div>
      <Modal
        ...
        isOpen={isOpen}
        className={'shadow-xl shadow-slate-300 select-none -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 h-full w-full absolute flex justify-between items-center rounded-md text-black'}
