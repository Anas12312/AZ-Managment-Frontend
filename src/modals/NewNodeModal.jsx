  ...
  return (
    <div>
      <Modal
        ...
        isOpen={isOpen}
        className={'shadow-xl shadow-slate-300 h-1/3 w-1/3 left-1/3 top-1/3 absolute flex flex-col justify-between items-center border p-5 rounded-md bg-secondary-2 text-black'}
